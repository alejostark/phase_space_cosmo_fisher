...
def v_esc_theory_w_z(r,z_c,alpha,rho_2_1e14,r_2,beta,omega_M,little_h,w0,wa):
    """cosmology"""
...
def v_esc_theory_flat(r,z_c,alpha,rho_2_1e14,r_2,beta,omega_M,little_h,w):
    """cosmology"""
    H_z = H_z_function(z_c, [w, omega_M,little_h],'flat')
    q_z= q_z_function(z_c,[w, omega_M],'flat')
...
def v_esc_theory_non_flat(r,z_c,alpha,rho_2_1e14,r_2,beta,omega_M,little_h,omega_DE):
    """cosmology"""
    H_z = H_z_function(z_c, [omega_DE, omega_M,little_h],'nonflat')
    q_z= q_z_function(z_c,[omega_DE, omega_M],'nonflat')
...
def v_esc_theory_non_flat_lil(r,z_c,alpha,rho_2_1e14,r_2,beta,lil_omega_M,lil_omega_lambda):
    """cosmology"""
...
def v_esc_theory_flat_lambda(r,z_c,alpha,rho_2_1e14,r_2,beta,little_h,omega_DE):
    """cosmology"""
